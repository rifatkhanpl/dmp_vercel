...
-  ('providers_registered', 'Providers Registered', 'Number of healthcare providers registered by user', 'productivity', 'count', 50),
-  ('bulk_imports_completed', 'Bulk Imports Completed', 'Number of successful bulk import operations', 'productivity', 'count', 10),
-  ('records_processed', 'Records Processed', 'Total number of records processed through imports', 'productivity', 'count', 500),
...
-  ('feature_usage_rate', 'Feature Usage Rate', 'Number of different features used by user', 'engagement', 'count', 8),
-  ('specialty_coverage', 'Specialty Coverage', 'Number of different specialties managed by user', 'coverage', 'count', 5),
-  ('ai_mapping_accuracy', 'AI Mapping Accuracy', 'Accuracy rate of AI-assisted field mapping', 'ai_performance', 'percentage', 90),
